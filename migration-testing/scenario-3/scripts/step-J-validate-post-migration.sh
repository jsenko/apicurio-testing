...
if ! curl -f -s "http://localhost:8080/apis/registry/v2/system/info" > /dev/null 2>&1; then
    echo "❌ Registry v2 API is not accessible at http://localhost:8080" | tee -a "$LOG_FILE"
